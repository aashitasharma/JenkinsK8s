...
-kops cli  using homebrew run the following...  brew update && brew install kops
-heml cli  using homebrew run the following... brew update && brew install kubernetes-helm
